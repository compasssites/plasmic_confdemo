...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: htyJhUOFf_G/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__fSvgQ)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__jdJmi)}
              role={"img"}
            />
          ),
